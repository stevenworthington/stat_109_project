...
boot_632 <- function(N, errSD, iter) {
...
parameter_search <- function(grid = pgrid, FUN = boot_632) {
  future_pmap(
...
ggsave(p, file = "Boot_632_combined.pdf", height = 6, width = 7)
