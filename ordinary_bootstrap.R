...
boot_ord <- function(N, errSD, iter) {
...
parameter_search <- function(grid = pgrid, FUN = boot_ord) {
  future_pmap(
...
ggsave(p, file = "Boot_ord_combined.pdf", height = 6, width = 7) 
